...
export function createNewWorkspaceForUser(session: UserSession): UserWorkspaceData {
  ...
  const singleParticipant: Participant = {
    ...
    organization: session.organization || 'Directorate of Technical Compliance',
  ...
  return {
    ...
    mode: 'individual',
    theme: 'gold',
    organizationName: 'Directorate of Technical Compliance',
    signatory1Name: 'Dr. Rajeshwari Sundaram, IAS',
    signatory1Title: 'Principal Reviewing Authority',
    signatory2Name: 'Adv. Vikramaditya Verma',
    signatory2Title: 'Chief Legal Auditor',
    singleParticipant,
    groupParticipants,
    currentStep: 'upload',
